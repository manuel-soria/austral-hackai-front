const UserIcon = (props: { color: string }) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_14_9684)">
        ...
        <path fillRule="evenodd" clipRule="evenodd"
              ...
              fill={props.color}/>
        <path fillRule="evenodd" clipRule="evenodd" d="M9 13C6.33 13 1 14.34 1 17V20H17V17C17 14.34 11.67 13 9 13Z"
              fill={props.color}/>
      </g>
      <defs>
        <clipPath id="clip0_14_9684">
