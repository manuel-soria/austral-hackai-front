...
const LeftNavigation = () => {
  ...
  return (
      <div className={"bg-primary-400 w-20 p-3.5 py-4 flex flex-col justify-between content-center"}>
        <div>
        ...
        <Image className={'border rounded-full border-black w-10 h-10'} src={profileImage} alt={'profile-picture'} width={40}
               height={40}/>
        </div>
      </div>
  )
